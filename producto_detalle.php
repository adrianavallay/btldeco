    ...
    <main class="producto">
                ...
                <div class="producto__info">
                    ...
                    <div class="producto__details">
                        ...
                        <div class="producto__detail">
                            ...
                            <div><strong>Stock</strong><span><?= $p['stock'] ?> disponibles</span></div>
                        </div>
                        <?php else: ?>
                        <div class="producto__detail">
                            ...
                            <div><strong>Stock</strong><span>Agotado — Consultar</span></div>
                        </div>
                        <?php endif; ?>
                        <div class="producto__detail">
                            ...
                            <div><strong>Entrega</strong><span>48hs habiles</span></div>
                        </div>
                        <div class="producto__detail">
                            ...
                            <div><strong>Envio</strong><span>A todo el pais</span></div>
                        </div>
                    </div>
                    ...
                    <?php else: ?>
                    <div class="producto__actions">
                        <span class="btn btn--outline btn--lg btn--full" style="opacity:0.5;justify-content:center;">PRODUCTO AGOTADO</span>
        ...
        <div class="container">
            <div class="producto__related">
                <h2 class="producto__related-title">Tambien te puede gustar</h2>
